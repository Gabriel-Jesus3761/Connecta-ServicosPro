        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600">Análise de desempenho de vendas e serviços</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <Card>
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  {salesData.topProfessionals.map(([professional, data], index) => {
                  ...
                  <tbody>
                    {Object.entries(salesData.servicesSales)
                      ...
                      .map(([service, data]) => {
                        ...
                        const performance = data.count > 10 ? 'Alta' : data.count > 5 ? 'Média' : 'Baixa'
                        const performanceColor =
                          performance === 'Alta' ? 'bg-green-100 text-green-700 border-green-200' :
                          performance === 'Média' ? 'bg-yellow-100 text-yellow-700 border-yellow-200' :
                          'bg-red-100 text-red-700 border-red-200'

                        return (
                          <tr key={service} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            <td className="py-3 px-4 text-sm font-medium text-gray-900">{service}</td>
                            <td className="py-3 px-4 text-sm text-gray-700 text-center">{data.count}</td>
